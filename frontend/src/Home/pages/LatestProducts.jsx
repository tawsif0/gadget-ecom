        ...
        <div className="text-center mb-8 md:mb-12">
          ...
          <div className="max-w-xl mx-auto">
            <p className="text-sm md:text-base text-gray-600 leading-relaxed">
              Discover our newest arrivals with cutting-edge features and
              exclusive introductory offers, organized by category.
            </p>
          </div>
        </div>
            ...
            {currentCategory.products.length > 3 && (
              <div className="text-center mt-8 md:mt-10">
                <button
                  ...
                  className="group inline-flex items-center justify-center gap-2 px-5 py-3 rounded-full font-semibold transition-all duration-300 hover:shadow-lg"
                  style={{
                    backgroundColor: isExpanded ? "#f3f4f6" : "#111827",
                ...
                >
                  ...
                  <FaArrowRight
                    className={`w-3.5 h-3.5 transition-all duration-300 ${
                      isExpanded
                        ? "rotate-180 text-gray-500 group-hover:-translate-x-0.5"
                        : "text-white/80 group-hover:translate-x-1"
                    }`}
                  />
                </button>
                <p className="text-xs text-gray-500 mt-2">
                  {isExpanded
                    ? `${currentCategory.products.length} products in ${currentCategory.categoryName}`
                    : `${currentCategory.products.length - 3} more products available`}
                </p>
              </div>
            )}
          </div>
        ...
        {currentCategory && currentCategory.products.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 text-sm max-w-md mx-auto mb-6">
              We're currently updating this category with exciting new arrivals.
            </p>
            <button
